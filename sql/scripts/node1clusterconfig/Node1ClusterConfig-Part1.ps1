...
try {
Start-Transcript -Path C:\cfn\log\node1clusterconfig-part1.ps1.txt -Append
...
Node1ClusterConfig -OutputPath 'C:\cfn\dsc\Node1ClusterConfig-Part1' -ConfigurationData $ConfigurationData -Credentials $Credentials

Start-DscConfiguration 'C:\cfn\dsc\Node1ClusterConfig-Part1' -Wait -Verbose -Force
